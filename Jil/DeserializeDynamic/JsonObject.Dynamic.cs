    ...
    sealed partial class JsonObject : IDynamicMetaObjectProvider
    {
        ...
        sealed class JsonMetaObject : DynamicMetaObject
        {
            ...
            public override DynamicMetaObject BindBinaryOperation(BinaryOperationBinder binder, DynamicMetaObject arg)
            {
                ...
                var finalResult = Expression.Variable(binder.ReturnType);
                var argRef = ArgRef;
                var argAssigned = Expression.Assign(argRef, (arg.RuntimeType == null || arg.RuntimeType._IsValueType()) ? Expression.Convert(arg.Expression, typeof(object)) : arg.Expression);
                var res = Res;
