...
namespace JilTests
{
    ...
    public class SpeedProofTests
    {
        ...
        public void UseArraySharing1a()
        {
            ...
            Func<TextReader, int, _UseArraySharing1> fast;
            Func<TextReader, int, _UseArraySharing1> normal;
            ...
            {
                {
                    ...
                    // Build the *actual* serializer method
                    fast = InlineDeserializerHelper.Build<_UseArraySharing1>(typeof(Jil.Deserialize.NewtonsoftStyle), dateFormat: Jil.DateTimeFormat.NewtonsoftStyleMillisecondsSinceUnixEpoch, exceptionDuringBuild: out ignored);
                }

                {
                    ...
                    // Build the *actual* serializer method
                    normal = InlineDeserializerHelper.Build<_UseArraySharing1>(typeof(Jil.Deserialize.NewtonsoftStyle), dateFormat: Jil.DateTimeFormat.NewtonsoftStyleMillisecondsSinceUnixEpoch, exceptionDuringBuild: out ignored);
                }
            }
            finally
            {
            ...
            var createData = InlineSerializerHelper.Build<_UseArraySharing1>(typeof(Jil.Serialize.NewtonsoftStyle), pretty: false, excludeNulls: false, jsonp: false, dateFormat: DateTimeFormat.NewtonsoftStyleMillisecondsSinceUnixEpoch, includeInherited: false, exceptionDuringBuild: out ignored);
            var rand = new Random(2323284);
        ...
        public void UseArraySharing1b()
        {
            ...
            Func<TextReader, int, List<_UseArraySharing1>> fast;
            Func<TextReader, int, List<_UseArraySharing1>> normal;
            ...
            {
                {
                    ...
                    // Build the *actual* serializer method
                    fast = InlineDeserializerHelper.Build<List<_UseArraySharing1>>(typeof(Jil.Deserialize.TypeCache<Jil.Deserialize.NewtonsoftStyle, _UseArraySharing1>), dateFormat: Jil.DateTimeFormat.NewtonsoftStyleMillisecondsSinceUnixEpoch, exceptionDuringBuild: out ignored);
                }

                {
                    ...
                    // Build the *actual* serializer method
                    normal = InlineDeserializerHelper.Build<List<_UseArraySharing1>>(typeof(Jil.Deserialize.TypeCache<Jil.Deserialize.NewtonsoftStyle, _UseArraySharing1>), dateFormat: Jil.DateTimeFormat.NewtonsoftStyleMillisecondsSinceUnixEpoch, exceptionDuringBuild: out ignored);
                }
            }
            finally
            {
        ...
        public void UseArraySharing2()
        {
            ...
            Func<TextReader, int, _UseArraySharing2> fast;
            Func<TextReader, int, _UseArraySharing2> normal;
            ...
            {
                {
                    ...
                    // Build the *actual* serializer method
                    fast = InlineDeserializerHelper.Build<_UseArraySharing2>(typeof(Jil.Deserialize.NewtonsoftStyle), dateFormat: Jil.DateTimeFormat.NewtonsoftStyleMillisecondsSinceUnixEpoch, exceptionDuringBuild: out ignored);
                }

                {
                    ...
                    // Build the *actual* serializer method
                    normal = InlineDeserializerHelper.Build<_UseArraySharing2>(typeof(Jil.Deserialize.NewtonsoftStyle), dateFormat: Jil.DateTimeFormat.NewtonsoftStyleMillisecondsSinceUnixEpoch, exceptionDuringBuild: out ignored);
                }
            }
            finally
            {
            ...
            var createData = InlineSerializerHelper.Build<_UseArraySharing2>(typeof(Jil.Serialize.NewtonsoftStyle), pretty: false, excludeNulls: false, jsonp: false, dateFormat: DateTimeFormat.NewtonsoftStyleMillisecondsSinceUnixEpoch, includeInherited: false, exceptionDuringBuild: out ignored);
            var rand = new Random(2323284);

            var arraySharingObject = new _UseArraySharing2();
            arraySharingObject.A = new int[10][];
            for (var i = 0; i < arraySharingObject.A.Length; ++i)
            {
                arraySharingObject.A[i] = new int[10];
                for (var j = 0; j < arraySharingObject.A[i].Length; ++j)
                {
            ...
            var toSerialize =
                Enumerable
                .Repeat(arraySharingObject, 2000)
                .ToList();
        ...
        [TestMethod]
        public void UseArraySharing3()
        {
            Exception ignored;

            Func<TextReader, int, _UseArraySharing3> fast;
            Func<TextReader, int, _UseArraySharing3> normal;

            try
            {
                {
                    InlineDeserializer<_UseArraySharing3>.ArraysShareBuildingList = true;

                    // Build the *actual* serializer method
                    fast = InlineDeserializerHelper.Build<_UseArraySharing3>(typeof(Jil.Deserialize.NewtonsoftStyle), dateFormat: Jil.DateTimeFormat.NewtonsoftStyleMillisecondsSinceUnixEpoch, exceptionDuringBuild: out ignored);
                }

                {
                    InlineDeserializer<_UseArraySharing3>.ArraysShareBuildingList = false;

                    // Build the *actual* serializer method
                    normal = InlineDeserializerHelper.Build<_UseArraySharing3>(typeof(Jil.Deserialize.NewtonsoftStyle), dateFormat: Jil.DateTimeFormat.NewtonsoftStyleMillisecondsSinceUnixEpoch, exceptionDuringBuild: out ignored);
                }
            }
            finally
            {
            ...
            var createData = InlineSerializerHelper.Build<_UseArraySharing3>(typeof(Jil.Serialize.NewtonsoftStyle), pretty: false, excludeNulls: false, jsonp: false, dateFormat: DateTimeFormat.NewtonsoftStyleMillisecondsSinceUnixEpoch, includeInherited: false, exceptionDuringBuild: out ignored);
            var rand = new Random(2323284);

            var arraySharingObject = new _UseArraySharing3();
            const int Length = 10;
            arraySharingObject.A = new int[Length];
            arraySharingObject.B = new int[Length];
            arraySharingObject.C = new int[Length];
            arraySharingObject.D = new int[Length];
            arraySharingObject.E = new int[Length];
            for (var j = 0; j < Length; ++j)
            {
                arraySharingObject.A[j] = rand.Next();
                arraySharingObject.B[j] = rand.Next();
                arraySharingObject.C[j] = rand.Next();
                arraySharingObject.D[j] = rand.Next();
                arraySharingObject.E[j] = rand.Next();
            }
